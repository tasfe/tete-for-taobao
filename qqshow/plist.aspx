      ...
      <dl>
        ...
        <dd><a href="http://auction1.paipai.com/<%#Eval("itemid") %>" title="<%#Eval("itemname") %>" onclick="javascript:spreadStat('<%=id %>','<%#Eval("itemid") %>');" target="_blank"><%#left(Eval("itemname").ToString(), 16)%></a></dd>
          ...
          <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
      <dl>
        <dt><a href="http://auction1.paipai.com/<%#Eval("Created") %>" title="<%#Eval("title") %>" target="_blank"><img src="<%#Eval("picurl") %>.2.jpg" border="0" /></a></dt>
        <dd><a href="http://auction1.paipai.com/<%#Eval("Created") %>" title="<%#Eval("title") %>" target="_blank"><%#left(Eval("title").ToString(), 16)%></a></dd>
      </dl>
      </ItemTemplate>
      </asp:Repeater>
                ...
                <TABLE cellSpacing=0 
                  cellPadding=0 align=center border=0><TBODY><TR><TD 
                      align="middle"><DIV 
                        ...
                        href="http://auction1.paipai.com/<%#Eval("Created") %>" 
                        target="_blank"><IMG 
