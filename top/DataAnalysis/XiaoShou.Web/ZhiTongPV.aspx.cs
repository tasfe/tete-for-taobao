...
public partial class ZhiTongPV : BasePage
{
    ...
    private void ShowChart(DateTime start, DateTime end)
    {
        ...
        List<TopSiteTotalInfo> list = new SiteTotalService().GetZhiTongTotal(start.ToString("yyyyMMdd"), end.ToString("yyyyMMdd"), nick);
        SeriseText = "[{name:'直通车流量', data:[";
        DateText = "[";
        ...
        for (DateTime i = start; i <= end; i = i.AddDays(1))
        {
            ...
            if (mylist.Count == 0)
                ...
                SeriseText += mylist[0].ZhiTongFlow + ",";
        }
