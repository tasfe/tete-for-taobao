...
<body style="padding: 0px; margin: 0px;">
    ...
    <div>
        <div class="navigation" style="height: 600px;">
            <div class="crumbs">
                <a href="javascript:;" class="nolink">销售分析王</a> 体检结果
            </div>
            <div class="absright">
                <ul>
                    <li>
            ...
            <div id="main-content">
           <div runat="server" id="div_Liulan" visible="false">
1.	客户浏览比率是否健康的处理提醒
...
i.	淘宝官方
ii.	卖家分享经验帖子(1-5)</div>
<div runat="server" id="div_SellGuanlian" visible="false">
2.	最近7天销售客单价是否正常提醒
...
ii.	关联搭配
iii.	卖家分享经验帖子</div>
<div runat="server" id="div_Zhuanhuan" visible="false">
3.	检查店铺浏览转换率是否健康
...
i.	宝贝装修
ii.	分享经验帖</div>
<div runat="server" id="div_SeeBack" visible="false">
4.	检查店铺浏览回头率是否健康
...
i.	促销布局装修
ii.	经验帖</div>
<div runat="server" id="div_TopGoods" visible="false">
7.	检查爆款商品购买率是否健康
