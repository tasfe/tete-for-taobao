...
{
    static string ipfilePath = System.Configuration.ConfigurationManager.AppSettings["ipdatapath"];
    ...
    ///<returns></returns>
    static int SearchIP(long[] ipArray, int start, int end, long ip)
    {
    ...
    ///</summary>
    ///<returns></returns>
    static byte[] ReadIPBlock(FileStream ipFile)
    {
    ...
    ///<returns></returns>
    static long ReadLongX(int bytesCount, FileStream ipFile)
    {
    ...
    ///<returns></returns>
    static string ReadString(int flag, FileStream ipFile)
    {
