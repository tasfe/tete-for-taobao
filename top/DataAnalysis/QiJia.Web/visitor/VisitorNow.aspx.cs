...
public partial class visitor_VisitorNow : BasePage
{
    ...
    private void Bind(DateTime start, DateTime end)
    {
        ...
        IList<TopVisitInfo> list = visitDal.GetVisitNowInfoList(Encrypt(HttpUtility.UrlDecode(Request.Cookies["nick"].Value)), start, end);
