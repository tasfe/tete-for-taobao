...
<div class="navigation" style="height:600px;">
  ...
  <div class="crumbs"><a href="#" class="nolink">手机推广魔盒</a> 添加广告 </div>
  <div class="absright">
    <ul>
      <li>
        <div class="msg">
    ...
    <div>
       <div>
         应用名： <asp:DropDownList ID="DDL_SiteList" runat="server" AutoPostBack="True" 
      ...
      <asp:Repeater ID="RPT_AdsList" runat="server" onitemcommand="RPT_AdsList_ItemCommand">
        <ItemTemplate>
           <tr>
              ...
              <td>
                <%# GetAdsSize(Eval("AdsId").ToString())%>
              </td>
              <td>
                <%# GetSiteName(Eval("SiteId").ToString()) %>
              </td>
              <td>
               <%# GetAdsName(Eval("AdsId").ToString())%>
              </td>
              <td>
                <img src='<%# Eval("AdsPic") %>' width="200px" height="100px" alt="" />
              </td>
              <td>
               <%# Eval("PositionCode")%>
              </td>
        ...
        <table>
           ...
           <tr>
              <td>广告类型：</td>
              <td>
               <asp:DropDownList ID="DDL_AdsList" runat="server"></asp:DropDownList>
              </td>
           </tr>
           <tr>
              <td>可放数量：</td>
