...
public partial class container : System.Web.UI.Page
{
    ...
    {
        string tetuiurl = Request.UrlReferrer.ToString().Replace("http://ding.7fshop.com/", "http://www.tetuiguang.com/");
    ...
    {
        string appkey = "12133190";
        string secret = "3442d45c5dcc79decbe8ff4db855a800";
        ...
        //判断短信购买及充值情况
        param.Add("nick", u);
        param.Add("article_code", "ts-22655");
    ...
    private void GetData(string nick)
    {
        ...
        TopXmlRestClient client = new TopXmlRestClient("http://gw.api.taobao.com/router/rest", "12133190", "3442d45c5dcc79decbe8ff4db855a800");
