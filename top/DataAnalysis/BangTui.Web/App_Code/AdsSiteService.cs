...
public class AdsSiteService
{
    ...
    const string SQL_DELETE_ADS = "DELETE FROM BangT_Ads WHERE AdsId=@AdsId";
    ...
    const string SQL_SELECT_ADS_BY_SITEID = "SELECT AdsId,SiteId,AdsName,AdsSize,AdsType,AdsPic FROM BangT_Ads WHERE SiteId=@SiteId";

    const string SQL_SELECT_ADS = "SELECT AdsId,SiteId,AdsName,AdsSize,AdsType,SiteId,AdsPic FROM BangT_Ads";
    ...
    {
        return DBHelper.ExecuteNonQuery(SQL_DELETE_ADS, new SqlParameter("@AdsId", adsId));
    }
