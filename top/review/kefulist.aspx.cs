...
public partial class top_review_kefulist : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (dt.Rows.Count != 0)
        {
            ...
            if (flag != "3")
            {
                string msg = "尊敬的" + nick + "，非常抱歉的告诉您，只有VIP版本才能使用【评价手动审核】功能，如需继续使用请<a href='http://pay.taobao.com/mysub/subarticle/upgrade_order_sub_article.htm?market_type=6&article_id=181' target='_blank'>购买高级会员服务</a>，谢谢！";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string sqlNew = "SELECT * FROM TopOrder WHERE nick = '" + nick + "' AND orderstatus = 'TRADE_FINISHED' AND issend = 2 AND kefustatus = 0 AND buynick = '" + search.Text.Trim().Replace("'", "''") + "'";
    ...
    private void BindData()
    {
        ...
        //分页数据初始化
        sqlNew = "SELECT COUNT(*) FROM TopOrder WHERE nick = '" + nick + "' AND orderstatus = 'TRADE_FINISHED' AND issend = 2 AND kefustatus = 0 AND reviewtime IS NOT NULL";
