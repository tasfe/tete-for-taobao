        ...
        if (dt.Rows.Count != 0)
        {
            ...
            switch (version)
            {
                ...
                case "1":
                    ...
                    break;
                case "2":
                    level = "专业版客户 <a href=http://fuwu.taobao.com/ser/detail.htm?service_code=service-0-22904&frm=haoping; target=_blank style=color:red;font-weight:bold>升级成VIP！</a>";
                    num = "30";
                    break;
                case "3":
                    level = "VIP版客户";
