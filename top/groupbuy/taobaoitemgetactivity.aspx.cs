    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (act == "get")
        {
            ...
            for (int i = 0; i < product.Content.Count; i++)
            {
               ...
               string str = " <table  width=\"600px;\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" style=\"margin:0px; padding:0px\">  <tr><td style=\" width:100px;\"><img src=" + product.Content[i].PicUrl + "_80x80.jpg></td><td  style=\" width:200px;\">" + product.Content[i].Title.Replace("%", "") + "</td><td  style=\" width:100px;\">" + product.Content[i].Price.ToString() + "</td><td  style=\" width:200px;\">" + tempstr + "</td></tr> </table>";
                Response.Write(str);
