    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (act == "getactivityitem")
        {
            ...
            for (int i = 0; i < product.Content.Count; i++)
            {
                ...
                string sql = "SELECT *  FROM  tete_activitylist where ProductID=" + product.Content[i].NumIid.ToString() + " and (Status=3 or Status=1 or Status=0) and activityID=" + aid + "  and nick='" + taobaoNick + "'";
