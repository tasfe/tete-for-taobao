...
public partial class top_blog_redirect : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        sql = "SELECT ISNULL(enddate,GETDATE()) FROM TopTaobaoShop WHERE nick = '" + taobaoNick + "'";
        ...
        {
            //跳转到订购页面
            Response.Redirect("http://container.open.taobao.com/container?appkey=12132145");
        }
        else
        {
            Response.Redirect("http://seller.taobao.com/fuwu/service.htm?service_id=764");
        }         
    }
}