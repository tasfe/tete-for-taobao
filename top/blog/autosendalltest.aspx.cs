...
public partial class top_blog_autosendalltest : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            //先判断这个会员发送的文章是否到上限
            sql = "SELECT COUNT(*) FROM TopBlog WHERE nick = '" + dt.Rows[i]["nick"].ToString() + "' AND DATEDIFF(d,GETDATE(),ADDDATE) = 0";
