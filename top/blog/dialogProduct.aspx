...
<body style="margin:0px; padding:0px;">
    ...
    <div>
        ...
        <div style="margin:10px;">
        	<input type="button" value="  插入商品  " class="button" onclick="InitData()" />
        	<input type="button" value="  关闭窗口  " class="button" onclick="CloseWindow()" />
        	<input type="button" value="  更新分类  " class="button" onclick="UpdateCategory()" />
            </div>
            <br />
            ...
            <tr>
                <td colspan="2">
                    商品样式选择：<br />
                    <input type="radio" name="style" value="0" id="Radio0" /> <label for="type0">无样式</label>
                    <input type="radio" name="style" value="1" id="Radio1" checked="checked" /> <label for="Radio1">样式1</label>
                </td>
            </tr>
            <tr>
    ...
    <script language="javascript" type="text/javascript">
        function InitData() {
            var str = document.getElementById("itemsStr").value;
            getResultStr(str);
        }
    ...
    function UpdateCategory() {
        ...
        var queryString = "http://www.7fshop.com/top/blog/taobaoitem.aspx?act=getCat&t=" + new Date().getTime();
    ...
    function getResultStr(str) {
        ...
        var queryString = "http://www.7fshop.com/top/blog/taobaoitem.aspx?act=getResultStr&style=" + style + "&ids=" + str + "&t=" + new Date().getTime();
        xmlHttp.open("GET", queryString);
    ...
    function spreadStat(pageid)
    {
        ...
        var catObj = document.getElementById("shopcat");
        var catid = catObj.options[catObj.options.selectedIndex].value;
        
        var pagenow = pageid;
        createxmlHttpRequest();
        var queryString = "http://www.7fshop.com/top/blog/taobaoitem.aspx?act=get&query="+escape(q)+"&catid="+catid+"&p="+pagenow+"&t="+new Date().getTime();
        xmlHttp.open("GET",queryString);
