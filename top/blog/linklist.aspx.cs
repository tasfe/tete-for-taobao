...
public partial class top_blog_linklist : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (act == "del")
        {
            string sqlnew = "DELETE FROM TopBlogLink WHERE nick = '" + taobaoNick + "' AND id = " + id;
        ...
        string sqlNew = "SELECT * FROM TopBlogLink WHERE nick = '" + taobaoNick + "' ORDER BY id DESC";
