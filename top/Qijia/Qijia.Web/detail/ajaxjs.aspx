<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ajaxjs.aspx.cs" Inherits="detail_ajaxjs" %>
// JavaScript Document
var nick = 'test';
...
function showTeteDialog(){
    document.getElementById("showArea").style.top = (event.clientY + document.documentElement.scrollTop) + "px";
