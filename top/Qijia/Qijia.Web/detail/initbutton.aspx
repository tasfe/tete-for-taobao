...
str += '<div id="showArea" style="display:none; position:absolute; top:1083px; left:305px; background-color:White; border:solid 1px #000; width:870px; height:770px; border:solid 2px #f48120; z-index:99999"><a href="javascript:CloseShowWindow()">关闭窗口</a><br /><iframe id="showFrame" src="http://qijia.7fshop.com/detail/dialog.html" width="866" height="770" frameborder="0"></iframe></div>';
document.write(str);
