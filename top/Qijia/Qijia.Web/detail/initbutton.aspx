...
str += '<div id="showArea" style="display:none; position:absolute; top:1083px; left:305px; background-color:White; border:solid 1px #000; width:870px; height:800px; border:solid 2px #f48120; z-index:99999"><div style="text-align:right"><a href="javascript:CloseShowWindow();">关闭窗口</a></div><iframe id="showFrame" src="" width="866" height="750" frameborder="0"></iframe></div>';
document.write(str);
