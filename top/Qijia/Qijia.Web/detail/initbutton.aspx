...
str += '<div id="showArea" style="display:none; position:absolute; top:1083px; left:305px; background-color:White; border:solid 1px #000; width:724px; height:570px; z-index:99999"><a href='CloseShowWindow()'>关闭窗口</a><br /><iframe id="showFrame" src="http://qijia.7fshop.com/detail/dialog.html" width="724" height="570" frameborder="0"></iframe></div>';
document.write(str);
