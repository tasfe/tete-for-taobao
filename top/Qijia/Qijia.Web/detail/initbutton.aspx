...
str += '<div id="alphaArea" style="display:none; background:#ccc;position:fixed;top: 0;left: 0;width:100%;height:100%;visibility: visible;filter:alpha(opacity=38);-moz-opacity: 0.382;opacity: 0.382;_position:absolute;_height:expression(document.body.scrollHeight);"></div>';
