...
public partial class top_callback : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            else if (module_width == "750" && nick == "美杜莎之心")
            {
                //if (nick == "美杜莎之心")
                //{
                Response.Redirect("reviewnew/haopingshow_750_2.aspx?nick=" + HttpUtility.UrlEncode(nick) + "&buynick=" + HttpUtility.UrlEncode(buynick) + "");
                //}
            }
            else
            {
