...
<div class="navigation" style="height:600px;">
  ...
  <div class="crumbs"><a href="javascript:;" class="nolink">二次销售魔方</a> 手机短信通知 </div>
  <div class="absright">
    <ul>
      <li>
        <div class="msg">
    ...
    <div id="main-content">
        ...
        <div style="border:solid 1px #CCE2FF; padding:4px; background-color:#E8F2FF; margin:0 3px 5px 0px; color:Red; font-weight:bold; width:700px">
            短信内容设置中的[shopname]、[buynick]、[gift]、[shiptyp]、[shipnumber]在短信发送时会被自动替换成您的 店铺名称、买家昵称、优惠券、快递方式和快递单号<br />
        </div>
        ...
        <table width="700">
            ...
            <tr id="Area1">
                <td align="left" width="250">
                    <textarea name="giftcontent" cols="40" rows="3" readonly="readonly"><%=giftcontent %></textarea>
                </td>
            </tr>
            <tr>
                <td align="left">
        开启订单发货后短信提示 <input id="fahuoflag" name="fahuoflag" type="checkbox" value="1" onclick="showArea4(this)" />
            ...
            <tr id="Area4">
                <td align="left" width="250">
                    <textarea name="fahuocontent" cols="40" rows="3" readonly="readonly"><%=fahuocontent%></textarea>
                </td>
            </tr>
            <tr>
                <td align="left">
        开启物流签收后短信提示 <input id="shippingflag" name="shippingflag" type="checkbox" value="1" onclick="showArea2(this)" />
            ...
            <tr id="Area2">
                <td align="left" width="250">
                    <textarea name="shippingcontent" cols="40" rows="3" readonly="readonly"><%=shippingcontent%></textarea>
                </td>
            </tr>
            <tr>
                <td align="left">
        开启过期未评价短信提示 <input id="reviewflag" name="reviewflag" type="checkbox" value="1" onclick="showArea3(this)" />
            ...
            <tr id="Area3">
                <td align="left" width="250">
                    <textarea name="reviewcontent" cols="40" rows="3" readonly="readonly"><%=reviewcontent%></textarea><br />
                    短信自动发送时间
