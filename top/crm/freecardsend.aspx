<%@ Page Language="C#" AutoEventWireup="true" CodeFile="freecardsend.aspx.cs" Inherits="top_crm_freecardsend" %>
...
<div class="navigation" style="height:600px;">
  ...
  <div class="crumbs"><a href="javascript:;" class="nolink">特特CRM_客户关系营销</a> 批量赠送包邮卡 </div>
  <div class="absright">
    <ul>
      <li>
        <div class="msg">
    ...
    <div id="main-content">
        ...
        <table width="700">
            ...
            <tr>
                ...
                <td>
                    <%=couponstr%>
                    <a href="../freecard/freecardadd.aspx">创建包邮卡</a>
                    <a href="../freecard/freecardlist.aspx">查看包邮卡赠送记录</a>
                </td>
            </tr>
            <tr>
