...
public partial class top_market_getuserinfo : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string sql = "SELECT * FROM TopTaobaoShop WHERE enddate >= GETDATE() AND session IS NOT NULL AND DATEDIFF(mm, date, '2011-9-1') > 4 AND DATEDIFF(mm, date, '2011-9-1') < 7 ORDER BY enddate DESC";
