...
<body style="margin:0px; padding:0px;">
    ...
    function updateCat() {
        ...
        var queryString = "http://www.7fshop.com/top/market/taobaoitem1.aspx?act=getCat&t=" + new Date().getTime();
    ...
    function getResultStr(str) {
        ...
        var queryString = "http://www.7fshop.com/top/market/taobaoitem1.aspx?act=getResultStr&isradio=1&style=" + style + "&ids=" + str + "&t=" + new Date().getTime();
        xmlHttp.open("GET", queryString);
    ...
    function spreadStat(pageid)
    {
        ...
        var pagenow = pageid;
        createxmlHttpRequest();
        var queryString = "http://www.7fshop.com/top/market/taobaoitem1.aspx?act=get&isradio=1&query=" + escape(q) + "&catid=" + catid + "&p=" + pagenow + "&t=" + new Date().getTime();
        xmlHttp.open("GET",queryString);
    ...
    function handleStateChange()
    {
        if(xmlHttp.readyState==4 && xmlHttp.status == 200)
        {
            ...
            taobaoitem.innerHTML = xmlHttp.responseText;
    ...
    return decodeURI(code.replace(/%/g, ''));
    } 
    */
