...
public partial class top_market_addweibosession : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string top_session = string.Empty;
        string nick = this.TextBox1.Text;

        string sql = "SELECT session FROM TopTaobaoShop WHERE nick = '" + nick + "'";
        top_session = utils.ExecuteString(sql);
