<%@ Page Language="C#" AutoEventWireup="true" CodeFile="resulthit.aspx.cs" Inherits="top_market_resulthit" %>
...
<div class="navigation" style="height:600px;">
  <div class="crumbs"><a href="../show.html">我的特特</a><a href="javascript:;" class="nolink">营销推广</a> 广告点击次数查看 </div>
  <div class="absright">
    <ul>
      <li>
        <div class="msg">
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <asp:Repeater ID="rptHitList" runat="server">
        <ItemTemplate>
