...
public partial class top_review_msgaddlist : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (result.IndexOf("\"article_user_subscribes\":{}") == -1)
            {
                ...
                Response.Redirect("msgaddlist.aspx");
            }
        }
    ...
    private void BindData()
    {
        ...
        string sqlNew = "SELECT TOP " + pageCount.ToString() + " * FROM (SELECT *,ROW_NUMBER() OVER (ORDER BY b.id DESC) AS rownumber FROM TCS_PayLog b WHERE b.nick = '" + nick + "') AS a WHERE a.rownumber > " + dataCount.ToString() + " ORDER BY id DESC";
        ...
        //分页数据初始化
        sqlNew = "SELECT COUNT(*) FROM TCS_PayLog WHERE nick = '" + nick + "'";
