    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (dt.Rows.Count != 0)
        {
            ...
            if (dt.Rows[0]["iscoupon"].ToString() == "1")
            {
                ...
                if (dt1.Rows.Count != 0)
                {
                    gift += "<div style='float:left; width:300px;'><img src='images/gift1.jpg'><br>★ 赠送优惠券【" + dt1.Rows[0]["name"].ToString() + "】满" + dt1.Rows[0]["condition"].ToString() + "元减" + dt1.Rows[0]["num"].ToString() + "元 （每人限领" + dt1.Rows[0]["per"].ToString() + "张）</div>";
                }
            }
            ...
            if (dt.Rows[0]["isfree"].ToString() == "1")
            {
                ...
                if (dt1.Rows.Count != 0)
                {
                    gift += "<div style='float:left; width:300px;'><img src='images/gift2.jpg'><br>★ 赠送包邮卡1张" + show(dt1.Rows[0]["areaisfree"].ToString(), dt1.Rows[0]["arealist"].ToString()) + "，满" + dt1.Rows[0]["price"].ToString() + "元可用，可用次数" + show1(dt1.Rows[0]["usecount"].ToString()) + "</div>";
                }
            }
            ...
            if (dt.Rows[0]["isalipay"].ToString() == "1")
            {
                ...
                if (dt1.Rows.Count != 0)
                {
                    gift += "<div style='float:left; width:300px;'><img src='images/gift3.jpg'><br>★ 赠送价值" + dt1.Rows[0]["num"].ToString() + "元支付宝红包1张 （每人限领" + dt1.Rows[0]["per"].ToString() + "张）</div>";
                }
            }
        }
    }
