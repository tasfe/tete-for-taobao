...
public partial class top_review_couponsend : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        string sql = "SELECT s.*,c.num,c.condition,t.totalprice,c.name FROM TCS_CouponSend s LEFT JOIN TCS_Coupon c ON c.guid = s.guid LEFT JOIN TCS_Trade t ON t.orderid = s.orderid WHERE s.nick = '" + nick + "' ORDER BY s.taobaonumber DESC";
        DataTable dt = utils.ExecuteDataTable(sql);
