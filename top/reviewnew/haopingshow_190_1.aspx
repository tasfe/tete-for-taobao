...
<script>    var pages = parseInt('3'); var total_num = parseInt('26'); var seller_name = encodeURI('etanliuyang'); var page_no = Math.floor(Math.random() * pages) + 1; var width = '190'; var c_record = 0; var loop_index = 0; var up_switch; var is_first = true; if (pages > 1 && page_no == pages) { page_no = 1 }; 
