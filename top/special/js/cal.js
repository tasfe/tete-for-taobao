...
(function ($) { // create private scope (inside you can use $ instead of jQuery)
    ...
    $.fn.simpleDatepicker = function (options) {
        ...
        function newDatepickerHTML() {
            ...
            jQuery("tfoot", table).append('<tr><td colspan="2"><span class="today">选择今天</span></td><td colspan="3">&nbsp;</td><td colspan="2"><span class="close">关闭窗口</span></td></tr>');
                ...
                if (
                    ...
                    cell
						...
						.click(function () {
						    ...
						    if (el.get(0).id == "starttime") {
						        $("input#endtime").val("");
						        //$('input#endtime').simpleDatepicker({ chosendate: '4/9/2011', startdate: '4/9/2011', enddate: '4/20/2011' });
						    }
						});
    ...
    jQuery.fn.simpleDatepicker.formatOutput = function (dateObj) {
        mmm = "0" + (dateObj.getMonth() + 1);
        if (mmm.length == 3) {
            mmm = mmm.substring(1, 3);
        }
        ddd = "0" + dateObj.getDate();
        if (ddd.length == 3) {
            ddd = ddd.substring(1, 3);
        }

        return dateObj.getFullYear() + "-" + mmm + "-" + ddd;
    };
