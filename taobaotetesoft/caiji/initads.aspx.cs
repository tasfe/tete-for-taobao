...
public partial class taobaotetesoft_caiji_initads : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        str += "else if(alimama_pid == 'mm_21154906_2327568_9010151'){alimama_pid='mm_11227037_3127410_10392602'; alimama_width=240; alimama_height=800; document.write('<script src=\"http://a.alimama.cn/inf.js\" type=\"text/javascript\"> ')}";

        str += "else if(alimama_pid == 'mm_21154906_2327568_9027111'){}";
